...
export async function updateSession(request: NextRequest) {
  ...
  // middleware and server-side RSC each create their own Supabase clients,
  // and the user's session will not be synced.
  ...
  if (
    ...
    !request.nextUrl.pathname.startsWith('/request-password-reset') &&
